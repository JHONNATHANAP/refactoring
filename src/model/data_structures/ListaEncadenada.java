...
public class ListaEncadenada<T extends Comparable<T>> implements ILista<T> {
	...
	public void createVacioException() {
		new VacioException();
	}

	public void createNullException() {
		new NullException();
	}

	public void createPosException() {
		new PosException();
	}
	...
	public void createListaEncadenada() {
		new ListaEncadenada();
	}
