...
public class ArregloDinamico<T extends Comparable<T>> implements ILista<T> {
	...
	private T getElement(int pos) throws PosException, VacioException {
		if (pos < 1) {
	...
	private T deleteElement(T dato) throws VacioException, NullException {
	...
	@Override
	private T deleteElement(int pos) throws PosException, VacioException {
		T elemento = null;
	...
	@Override
	private T firstElement() throws VacioException {
		T retorno = null;
		if (tamanoAct == 0) {
			throw new VacioException("La lista está vacía");
		} else {
	...
	private ILista<T> sublista(int pos, int numElementos) throws PosException, VacioException, NullException {
		if (isEmpty()) {
			throw new VacioException("La lista está vacía");
	...
	@Override
	private int compareTo(ILista o) {
